# change Terminal: chsh -s /bin/bash
#!/bin/sh
...
gmt grdcut GEBCO_2019.nc -R39/70/-27/12 -Gsom_relief.nc
...
gmt makecpt -Cgeo.cpt -V -T-6704/4325 > myocean.cpt
...
# gmt psconvert Bathymetry_Som.ps -A1.0c -E720 -Tf -Z
gmt psconvert Bathymetry_Som.ps -A1.0c -E300 -Tf -Z
